...
class NetworkDataExtract:
    ...
    def insert_data_to_mongo(self, collection, records, database):
        try:
...
if __name__ == "__main__":
    ...
    no_of_records=networkobj.insert_data_to_mongo(collection=Collection, records=records, database=DATABASE)
